          ...
          Container(
            ...
            child: Stack(
              children: [
                ...
                Padding(
                  padding: const EdgeInsetsDirectional.fromSTEB(3.0, 3.0, 12.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
                ...
                Padding(
                  padding:
                      const EdgeInsetsDirectional.fromSTEB(0.0, 134.0, 12.0, 0.0),
                  child: Row(
                    mainAxisSize: MainAxisSize.max,
